...
name_model_run = 'model_2020-09-15_18:57:17.170622'   #'model_shuffle_test_2020-06-26_08:22:34.551302'
# directory where model is saved
save_model_path = '/media/kiran/D0-P1/animal_data/meerkat/new_run_sep_2020'#'/media/kiran/D0-P1/animal_data/meerkat/saved_models/'
...
save_data_path = '/media/kiran/D0-P1/animal_data/meerkat/new_run_sep_2020' #'/media/kiran/D0-P1/animal_data/meerkat/preprocessed/'
...
directories = [save_data_path, 
               ...
               save_pred_stack_test_path, save_pred_table_test_path]
...
train_log = "/media/kiran/D0-P1/animal_data/meerkat/new_run_sep_2020/label_table/training_files_used.txt"
...
for file_ID in testing_filenames:
    ...
    # do a loop with the different threshold values

    # high_thr = 0.8
    # for high_thr in np.arange(0.3,0.9,0.1):
    #     high_thr = round(high_thr,1)
    #     # print(high_thr)
    #     # high_thr = np.arange(0.3,0.9,0.1)[0]
    ...
    for loopi in range(0, int(len(loop_times)), 2): 
        ...
        np.save( os.path.join(save_pred_stack_test_path, file_ID + '_PRED_STACK.npy'), pred_list)
        with open(os.path.join(save_pred_stack_test_path, file_ID + '_PRED_STACK.txt'), "w") as f:
