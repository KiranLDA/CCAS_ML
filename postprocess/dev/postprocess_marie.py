...
def merge_p(probabilities, starttime=datetime.timedelta(0), frameadv_s=0.010, specadv_s=3.0,
    ...
    scanners = [FindDetections(l, low_thr, high_thr, specadv_n) for l in range(catsN-1)]
