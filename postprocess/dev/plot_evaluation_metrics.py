...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov  5 15:31:04 2020
...
label_dirs = ["/home/kiran/Dropbox/CCAS_big_data/meerkat_data/meerkat_data_2017/labels_CSV", #2017 meerkats
            "/home/kiran/Dropbox/CCAS_big_data/meerkat_data/meerkat_data_2019/labels_CSV"]
...
models_paths = ["/home/kiran/Dropbox/CCAS_big_data/ML_data/NoiseAugmented_NoOther/new_evaluation_innerloop/NoiseAugmented_NoOther_2020-10-06_22:35:04.511239/savedmodel.h5",
                "/home/kiran/Dropbox/CCAS_big_data/ML_data/NoiseAugmented_ProportionallyWeighted_NoOther/new_evaluation_innerloop/NoiseAugmented_ProportionallyWeighted_NoOther_2020-10-14_03:12:32.817594/savedmodel.h5",    
                "/home/kiran/Dropbox/CCAS_big_data/ML_data/new_run_sep_2020/new_evaluation_innerloop/model_2020-09-15_18:57:17.170622/savedmodel.h5"]
...
import postprocess.merge_predictions_functions as ppm
    ...
    for low_thr in [0.2]:
        for high_thr in [0.5,0.7,0.9]: 
            ...
            low_thr = round(low_thr,2)                               
            high_thr = round(high_thr,2) 
            confusion_filename = os.path.join(root_paths[i], "metrics_old", "Overall_PRED_TABLE_thr_" + str(low_thr) + "-" + str(high_thr) +'_overlap_' + str(overlap) + '_Confusion_matrix_2.csv')
