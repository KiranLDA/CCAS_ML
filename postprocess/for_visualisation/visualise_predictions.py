...
test_path = '/media/kiran/D0-P1/animal_data/meerkat/preprocessed/test_data/'
...
spec, label, pred = pp.predict_label_from_random_spectrogram(RNN_model, "_cc_", save_spec_path, save_mat_path)
