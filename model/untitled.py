...
train_generator = batch_generator.Batch_Generator(x_train_filelist, y_train_filelist, batch, False)
val_generator = batch_generator.Batch_Generator(x_val_filelist, y_val_filelist, batch, False)
test_generator = batch_generator.Batch_Generator(x_test_filelist, y_test_filelist, batch, False)
...
inp = Input(shape=  x_train.shape[1:len(x_train.shape)])
