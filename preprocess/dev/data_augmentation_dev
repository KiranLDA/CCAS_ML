"""
Created on Mon Aug 10 12:03:17 2020

This code is for doing noise augmentation
...
def augment_with_noise(spec_filepaths, wav_filepaths, calltype, noise, scaling_factor, random_range, 
                       spec_window_size, n_mels, window, fft_win, fft_hop, normalise):
    '''
    ...
    augmented_spectrogram = pre.generate_mel_spectrogram(test, sr, 0, spec_window_size, 
                         n_mels, window, fft_win , fft_hop , normalise)
    return(augmented_data, augmented_spectrogram)
